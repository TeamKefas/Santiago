...
namespace Santiago
{
    enum ErrorCode
    {
        ...
        ERR_INVALID_EMAIL_ADDRESS_RECOVERY_STRING = 7,
        ERR_INVALID_SESSION_COOKIE = 8,
        ERR_INVALID_FASTCGI_REQUEST = 9,
        ERR_FASTCGI_REQUEST_ALREADY_REPLIED = 10,
        ERR_INVALID_FASTCGI_VERSION = 11,
        ERR_SOCKET_ERROR = 12
    };
