...
namespace Santiago
{
    enum ErrorCode
    {
        ...
        ERR_NO_ACTIVE_SESSION_FOR_USERNAME = 9,
        ERR_INVALID_SESSION_COOKIE = 10,
        ERR_INVALID_FASTCGI_REQUEST = 11,
        ERR_FASTCGI_REQUEST_ALREADY_REPLIED = 12,
        ERR_INVALID_FASTCGI_VERSION = 13,
        ERR_SOCKET_ERROR = 14
    };
