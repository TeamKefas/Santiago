#ifndef SANTIAGO_AUTHENTICATION_SERVER_CONNECTIONMESSAGESOCKET_H
#define SANTIAGO_AUTHENTICATION_SERVER_CONNECTIONMESSAGESOCKET_H
...
}}} //closing namespace Santiango::Authentication::Server
