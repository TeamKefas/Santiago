...
namespace Santiago{ namespace Authentication{ namespace MultiNode
        {
            ...
            protected:
                ...
                void createUserImpl(const std::string& userName_,
                                    const std::string& emailAddress_,
                                    const std::string& password_,
                ...
                void loginUserImpl(const std::string& userNameOrEmailAddress_,
                                   bool isUserNameNotEmailAddress_,
                                   const std::string& password_,
                ...
                void verifyCookieAndGetUserInfoImpl(const std::string& cookieString_,
                ...
                std::error_code logoutUserForCookie(const std::string& cookieString_,
                                                    boost::asio::yield_context yield_);
       
                void logoutUserForCookieImpl(const std::string& cookieString_,
                ...
                std::error_code logoutUserForAllCookies(const std::string& userName_,
                                                        boost::asio::yield_context yield_);
        
                void logoutUserForAllCookiesImpl(const std::string& userName_,
                ...
                void changeUserPasswordImpl(const std::string& cookieString_,
                                            const std::string& oldPassword_,
                                            const std::string& newPassword_,
                ...
                void getUserForEmailAddressAndRecoveryStringImpl(const std::string& emailAddress_,
                                                                 const std::string& recoveryString_,
                ...
                void changeUserPasswordForEmailAddressAndRecoveryStringImpl(const std::string& emailAddress_,
                                                                            const std::string& recoverystring_,
                                                                            const std::string& newPassword_,
                ...
                void changeUserEmailAddressImpl(const std::string& cookieString_,
                                                const std::string& newEmailAddress_,
                                                const std::string& password_,
                ...
                void createAndReturnRecoveryStringImpl(const std::string& emailAddress_,
                ...
                std::error_code deleteUser(const std::string& cookieString_,
                                           boost::asio::yield_context yield_);

                void deleteUserImpl(const std::string& cookieString_,
